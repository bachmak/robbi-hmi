...
docker-compose up -d
\end{verbatim}
    On first run, Docker will pull or build all required images before starting the containers.
    This may take several minutes depending on network speed and machine performance.
    Wait until all containers report a healthy status before proceeding.
