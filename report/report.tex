...
From an operational perspective, the hybrid setup is closer to realistic deployments, where PLC/
engineering tooling and application services are typically not co-located inside one VM. The
...
\autoref{sec:deployment-strategies} (single-machine and VM + Host). A concise run sequence
